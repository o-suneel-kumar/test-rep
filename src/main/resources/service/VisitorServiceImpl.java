...
public class VisitorServiceImpl implements VisitorFacade {
	 ...
	 *  
	 *  PSEUDOCODE: <br/>
	 * 	Call registerupdateEventNominationsVisitorToEvent () in a new DAO object.<br/>
	 * 	Call () in a new DAO object.<br/>
	 * 	Catch all possible exceptions and log to the error file the provided exception message.<br/> 
	 *  <br/>
	 *   
	 * 	@param visitor (type Visitor)
	...
	public void RegisterVisitor(Visitor visitor, int eventid) {
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			log.info("ClassNot Found Exception");
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public ArrayList<Event> showRegisteredEvents(Visitor visitor) {
		...
		// TODO:  Add code here.....
		ArrayList<Event> registeredEvents=null;
		...
		return registeredEvents; // TODO Replace "null" with "ArrayList<Event>" collection, based on updates to code in the TODO section.
	}
